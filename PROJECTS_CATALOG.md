...
| :-: | :--- | :--- | :--- | :--- |
| **1** | **CHED Compliance Portal** | [https://zppsu-ched-compliance.pages.dev](https://zppsu-ched-compliance.pages.dev) | **Program Chair (Admin):** `chair.malangas@zppsu.edu.ph` / `admin` (or `admin123`)<br>**CHED Evaluator:** `evaluator.ched@ched.gov.ph` / `ched2026` (or `rqat2026`)<br>**Faculty (19 Instructors):** Default: `faculty123`<br>*Includes live interactive role switcher sandbox in UI* | **Cloudflare Pages** + Cloudflare D1 (`zppsu-ched-db`) + Google Apps Script API + Google Drive |
| **2** | **BatasPh (CivicPH)** | [https://civic-ph.vercel.app](https://civic-ph.vercel.app) | **Public Access:** Legal search, Republic Acts, City Ordinances<br>**Capacitor Android:** `com.civicph.app` (`CivicPH`)<br>**GitHub:** [imdcluy-ctrl/BatasPh](https://github.com/imdcluy-ctrl/BatasPh.git) | **Vercel** + Next.js 16 + React 19 + Tailwind v4 + Prisma |
| **3** | **Flexible Admissions Tracker** | [https://zppsu-admissions.vercel.app](https://zppsu-admissions.vercel.app)<br>*(Alt: [flexible-daily-admissions-tracking.vercel.app](https://flexible-daily-admissions-tracking.vercel.app))* | **Executive Dean View:** `superior.admin@school.edu.ph` / `AdminPass2026!`<br>**ComTech Chair:** `chair.comtech@school.edu.ph` / `CptChair2026!`<br>*Features zero-setup instant demo mode in LocalStorage* | **Vercel** + React 19 + Vite 8 + Tailwind v4 + Supabase Auth/DB |
| **4** | **EPDU Palaro 2026 Chess** | [https://epdu-chess-2026.imdcluy.workers.dev](https://epdu-chess-2026.imdcluy.workers.dev) | **Admin Login:** `/admin/login`<br>**Admin Master Password:** `palaro2026admin`<br>*5-campus tournament manager with offline LAN JSON export* | **Cloudflare Workers** + Hono + Cloudflare D1 (SQLite Edge) |
...
| **6** | **CPT Palaro Management System** | [https://cpt-palaro.netlify.app](https://cpt-palaro.netlify.app)<br>*(Alt: [comtech-palaro-webapp.netlify.app](https://comtech-palaro-webapp.netlify.app))* | **Master Admin:** `admin` / `admin1234`<br>**Coordinators:** `reymark.sipe` / `palaro2026`, `randy.monteza` / `palaro2026`<br>**Test Accounts:** `test.student`, `test.tl`, `test.faculty` / `palaro2026`<br>**GitHub:** [DarkPrince15/Cpt-Palaro-Management-Sys](https://github.com/DarkPrince15/Cpt-Palaro-Management-Sys.git) | **Netlify** + React + Vite + Express + Better-SQLite3 / Supabase |
| **7** | **Document Submission Tracker** | [Live GAS Web App](https://script.google.com/macros/s/AKfycbypRMB1ssxs5f8JZ1kY3xHYpG1tziueKVh_Tr75SGwFBrLb2fECXXwRlKGHuqMPhbfyNQ/exec) | **Program Chair Passcode:** `ZPPSU-CT-2026`<br>**Google Drive Storage:** Direct sync to department folders | **Google Apps Script** + Google Drive API + Google Sheets DB |
...
- **Key Features:** Dynamic QR code athlete credentials, coach/arbiter approval queues, public team standings, role-based dashboards (`admin1234`, `palaro2026`).
